...
def get_args():
    ...
    parser.add_argument("--batch-size", type=int, default=256, help="number of batch size, (default, 512)")
...
def main():
    ...
    #model_name = "MobileNet_"+str(args.dataset_mode)+"_epochs"+str(args.epochs)

    model = MobileNetV3_Acnet(model_mode=args.model_mode, num_classes=num_classes, multiplier=args.multiplier, dropout_rate=args.dropout).to(device)
    model_name = "acnet_MobileNet_v2_"+ str(args.dataset_mode) +"_epochs"+str(args.epochs)
