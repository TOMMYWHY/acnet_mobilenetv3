...
2. 尝试修改 model 
```shell script
python main.py --dataset-mode CIFAR10 --load-pretrained True --model-mode SMALL
```
3. 优化。 将所有conv2d->grconv 参数扩大6倍
4.  只改dw层conv2d
5. 根据acnet 论文。节点自我推理(1*1)；与相邻接点推理(3*3)；全局推理(fz).根据kernel的数值实现不同的连接方式。
------
v1
> #org 3111462
    ...
    #224  fc: linear 1; Grconv: z1+zf; ancnet  1*1(2) param:3453118 testing....
